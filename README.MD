...
Running this code as a Kubernetes cluster deployed in the same data center as the Qumulo cluster allowed the resolution of 80,000 locks in around 16 seconds.
